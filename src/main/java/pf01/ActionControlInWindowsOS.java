...
/*     */ class ActionControlInWindowsOS
...
/* 509 */       return; }
/* 510 */     if ((!getPath.substring(1, 2).equals(":")) && (!getPath.substring(1, 2).equals("\\"))) {
/* 511 */       PF0101.tfGetFile.setBackground(new Color(255, 160, 160));
/* 512 */       JOptionPane.showMessageDialog(null, "檔案母位置須為絕對路徑", "警告", 2);
/* 513 */       return; }
/* 514 */     if ((!savePath.substring(1, 2).equals(":")) && (!savePath.substring(1, 2).equals("\\"))) {
/* 515 */       PF0101.tfSaveFile.setBackground(new Color(255, 160, 160));
/* 516 */       JOptionPane.showMessageDialog(null, "存檔位置須為絕對路徑", "警告", 2);
/* 517 */       return;
/*     */     }
...
/* 528 */       if ((temp[i].length() > 2) && (
/* 529 */         (temp[i].substring(1, 2).equals(":")) || (temp[i].substring(1, 2).equals("\\")))) {
...
/* 562 */       return; }
/* 563 */     if ((!getPath.substring(1, 2).equals(":")) && (!getPath.substring(1, 2).equals("\\"))) {
/* 564 */       PF0101.tfGetFile.setBackground(new Color(255, 160, 160));
/* 565 */       JOptionPane.showMessageDialog(null, "檔案母位置須為絕對路徑", "警告", 2);
/* 566 */       return; }
/* 567 */     if ((!savePath.substring(1, 2).equals(":")) && (!savePath.substring(1, 2).equals("\\"))) {
/* 568 */       PF0101.tfSaveFile.setBackground(new Color(255, 160, 160));
/* 569 */       JOptionPane.showMessageDialog(null, "存檔位置須為絕對路徑", "警告", 2);
/* 570 */       return; }
...
/* 651 */         return; }
/* 652 */       if ((!getPath.substring(1, 2).equals(":")) && (!getPath.substring(1, 2).equals("\\"))) {
/* 653 */         PF0101.tfGetFile.setBackground(new Color(255, 160, 160));
/* 654 */         JOptionPane.showMessageDialog(null, "檔案母位置須為絕對路徑", "警告", 2);
/* 655 */         return; }
/* 656 */       if ((!savePath.substring(1, 2).equals(":")) && (!savePath.substring(1, 2).equals("\\"))) {
/* 657 */         PF0101.tfSaveFile.setBackground(new Color(255, 160, 160));
/* 658 */         JOptionPane.showMessageDialog(null, "存檔位置須為絕對路徑", "警告", 2);
/* 659 */         return;
/*     */       }
